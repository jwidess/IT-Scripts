...
### [Check_AD_Default_Location.ps1](Active%20Directory/Check_AD_Default_Location.ps1)
Checks and displays the default Active Directory containers for new users and computers in the current domain.

### [Check_Domain_Response.ps1](Active%20Directory/Check_Domain_Response.ps1)
...
### [Get_AD_User&Computers.ps1](Active%20Directory/Get_AD_User%26Computers.ps1)
...
### [Update_ADMX_Files.ps1](Active%20Directory/Update_ADMX_Files.ps1)
...
### [TypeClipboard.ahk](AHK/TypeClipboard.ahk)
...
### [Get_MFA_User_Status.ps1](Entra/Get_MFA_User_Status.ps1)
...
### CVE
#### [GatherCVEInfoV2.ps1](Other/CVE/GatherCVEInfoV2.ps1)
...
##### [BackupToDrive.ps1](Windows/Backup%20Scripts/Prior%20to%20Reinstall%20Backup/BackupToDrive.ps1)
...
##### [Backup_StartMenuItems.ps1](Windows/Backup%20Scripts/Win%2011%20Start%20Menu%20Pinned%20Items%20Backup/Backup_StartMenuItems.ps1)
...
##### [Users_Folder_Backup.ps1](Windows/Backup%20Scripts/Windows%20Users%20Folder%20Backup/Users_Folder_Backup.ps1)
...
#### [Get_Access_Folder_Recurse.ps1](Windows/File%20Permissions/Get_Access_Folder_Recurse.ps1)
...
#### Personal Folders
##### [PersonalFolderPermissions.ps1](Windows/File%20Permissions/Personal%20Folders/PersonalFolderPermissions.ps1)
...
##### [CSVListPersonalFolderPermissions.ps1](Windows/File%20Permissions/Personal%20Folders/CSVListPersonalFolderPermissions.ps1)
...
#### [Firewall_Block_All_EXE_in_Folder_Mk2.ps1](Windows/Firewall/Firewall_Block_All_EXE_in_Folder_Mk2.ps1)
...
#### [Firewall_UNBlock_All_EXE_in_Folder_Mk2.ps1](Windows/Firewall/Firewall_UNBlock_All_EXE_in_Folder_Mk2.ps1)
Removes Windows Firewall blocking rules for all .exe files in the current directory and subdirectories.

#### [OLD-Block Firewall All In Folder.bat](Windows/Firewall/OLD-Block%20Firewall%20All%20In%20Folder.bat)
Legacy batch script version that recursively blocks all .exe files in a folder using netsh commands.

### Get Computer Info

#### [Get_Device_Info_V2.ps1](Windows/Get%20Computer%20Info/Get_Device_Info_V2.ps1)
...
#### [Get_Disk_Info.ps1](Windows/Get%20Computer%20Info/Get_Disk_Info.ps1)
Gathers information about physical disks, partitions, and volumes, including SMART status via smartmontools if installed.

#### [Get_WSL_info.ps1](Windows/Get%20Computer%20Info/Get_WSL_info.ps1)
...
#### [List_Installed_Software_CSV.ps1](Windows/List%20Installed%20Software/List_Installed_Software_CSV.ps1)
...
#### [Fix Internet after VPN.bat](Windows/Other%20Utilities/Fix%20Internet%20after%20VPN.bat)
Deletes the 0.0.0.0 route and renews IP configuration to fix internet connectivity issues after disconnecting from VPN.

#### [Real Time.bat](Windows/Other%20Utilities/Real%20Time.bat)
Displays a continuously updating real-time clock in the command prompt window.

### Registry

#### [Find_Registry_Keys.ps1](Windows/Registry/Find_Registry_Keys.ps1)
...
#### Windows Updates
##### [Remove_KB5063878.ps1](Windows/Uninstall%20Scripts/Windows%20Updates/Remove_KB5063878.ps1)
...
#### Xbox Removal
##### [RemoveXbox_Logon.ps1](Windows/Uninstall%20Scripts/Xbox%20Removal/RemoveXbox_Logon.ps1)
Logon script that removes Xbox-related packages for the current user when they log in.

##### [RemoveXboxV2.ps1](Windows/Uninstall%20Scripts/Xbox%20Removal/RemoveXboxV2.ps1)
...
#### [WinFix JDW #1.bat](Windows/WinFix/WinFix%20JDW%20%231.bat)
...
#### [WinFix JDW #1 - NON ADMIN.bat](Windows/WinFix/WinFix%20JDW%20%231%20-%20NON%20ADMIN.bat)
Non-administrator version of WinFix

#### [WinFix-Original.bat](Windows/WinFix/WinFix-Original.bat)
...
#### [Resize_script.ps1](Windows/WinRE%20Fix%20%280x80070643%29/Resize_script.ps1)
